...
class NERELEvaluator:
    ...
    def add_predictions(self, gold_relations: Set[Tuple], pred_relations: Set[Tuple]):
        """
...
def process_nerel_files(test_dir: str, 
    ...
    for txt_file in txt_files:
        ...
        try:
            ...
            # Evaluate
            evaluator.add_predictions(gold_relations, pred_relations)
...
def print_results(metrics: Dict):
    ...
    print("="*80)
    print(f"{'Relation':<20} {'Precision':<10} {'Recall':<10} {'F1':<10} {'Support':<10}")
    print("-" * 80)
    ...
    for rel_type, metrics_rel in sorted_relations:
        print(f"{rel_type:<20} {metrics_rel['precision']:<10.4f} {metrics_rel['recall']:<10.4f} "
              f"{metrics_rel['f1']:<10.4f} {metrics_rel['support']:<10}")
...
def main():
    ...
    parser.add_argument('--model_path', default='./logs/nerel-ckpt',
                      help='Path to trained model')
    parser.add_argument('--config_path', default='./dreeam-config.json',
